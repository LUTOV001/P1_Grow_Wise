...
def sharpe_return(high_sharpe_tickers,med_sharpe_tickers,low_sharpe_tickers):
    ...
    MC_10_yrs_high_sharpe_line_plot
    ...
    MC_10_yrs_high_sharpe_distribution_plot
    ...
    MC_10_yrs_med_sharpe_line_plot
    ...
    MC_10_yrs_med_sharpe_distribution_plot
    ...
    MC_10_yrs_low_sharpe_line_plot
    ...
    MC_10_yrs_low_sharpe_distribution_plot
...
def beta_return(high_beta_tickers,med_beta_tickers,low_beta_tickers):
    ...
    MC_10_yrs_high_beta_distribution_plot
    ...
    MC_10_yrs_med_beta_distribution_plot
